...
import com.bootcamp_android.domain.usecases.CalculateFreeLots
...
class LotsViewModel(
    ...
    private val calculateFreeLots: CalculateFreeLots
) : ViewModel() {
    ...
    fun loadLots() = viewModelScope.launch {
        ...
        freeLots = _lots.value?.let { calculateFreeLots(it) }!!
    }
}