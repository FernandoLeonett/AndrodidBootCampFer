...
class Provider {
    ...
    companion object {
        ...
        fun reservations(cant: Int,n: Int): MutableList<Reservation> {
            val reservations = mutableListOf<Reservation>()

            for(i in 0..cant) {
                reservations.add(Reservation("1234",starDateTest,(starDateTest..endDateTest).random(),(1..n).random()))
            }
